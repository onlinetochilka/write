        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl ring-1 ring-stone-200/60 p-8">
          ...
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              ...
              <div className="text-xs text-stone-500">Вход в аккаунт</div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="login-password" className="block text-sm font-medium text-stone-700 mb-1">Пароль</label>
          ...
          <div className="mt-4 text-center">
            <button className="text-sm text-brand-blue hover:underline">Забыли пароль?</button>
          </div>

          <div className="border-t border-stone-200/60 mt-6 pt-6 text-center">
            <span className="text-sm text-stone-500">Нет аккаунта? </span>
            <Link to="/register" className="text-sm font-medium text-brand-blue hover:underline">Зарегистрироваться</Link>
          </div>
        </div>
      </div>
    </div>
